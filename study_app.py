...
이미지를 읽고 기사 내용을 요약·해설해줘.
원문을 길게 그대로 옮기지 말고, 핵심만 정리해라.

가장 중요한 규칙:
- 관련 종목은 반드시 한국거래소(KRX)에 상장된 한국 종목만 제시한다.
- 엔비디아, AMD, 마이크론, TSMC, ASML, 램리서치, KLA, 퀄컴, 인텔 같은 해외 기업은 관련 종목 목록에 절대 넣지 않는다.
- 해외 기업은 고객사/경쟁사 설명에서만 언급 가능하다.
...
- 기사에 직접 등장하지 않아도 산업 밸류체인상 수혜 가능성이 있으면 추론해서 제시
관련 종목은 암기된 종목을 반복하지 말 것.
